    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden rounded-t-2xl bg-secondary/10 dark:bg-[#0f172a] p-6 flex items-center justify-center group-hover:bg-secondary/20 dark:group-hover:bg-[#161f33] transition-colors duration-500">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="absolute top-6 right-4 z-20 p-2 bg-background/90 backdrop-blur-md rounded-full text-foreground/70 hover:text-neon-pink transition-all duration-300 shadow-sm hover:shadow-md border border-border/50 group/wishlist"
